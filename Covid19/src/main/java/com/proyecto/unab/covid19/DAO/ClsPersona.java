...
import com.proyecto.unab.covid19.entidades.*;

import lombok.var;

import com.proyecto.unab.covid19.conexion.*;
...
public class ClsPersona {
	...
	public boolean LoguinPersona(String Usuario, String Password) {
        ...
        try {
            ...
            for (Persona iterar : ListadoUSUARIOPASS) {
            ...
            for (Persona iterar : ListarContra) {
